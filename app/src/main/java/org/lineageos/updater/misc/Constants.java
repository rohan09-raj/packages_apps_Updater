...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.blaster.version";
    public static final String PROP_BUILD_VERSION_INCREMENTAL = "ro.build.version.incremental";
    public static final String PROP_DEVICE = "ro.blaster.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "blaster.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "blaster.updater.uri";
